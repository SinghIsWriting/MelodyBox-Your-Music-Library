...
let rp = 0;
let duration;
// https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main
async function getSong(folder) {
    let response = await fetch(
      `https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/${folder}`
    );
    ...
    for (let index = 0; index < songs.length; index++) {
        ...
        songList.innerHTML =
          ...
          `<li><div class="songCard">
                                <div class="img">
                                    <img style="height: 36px; width: 36px; border-radius: 35px;" src="https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/${currentFolder}/cover.jpg"
                                        alt="pic"></div>
                                ...
                                <div class="playBtn">
                                    <img src="https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/images/play.svg" style="width: 20px; height: 20px;" alt="pic">
                                </div>
                            </div></li>`;
    }
    Array.from(document.querySelector(".playlistBox").getElementsByTagName("li")).forEach((e) => {
        e.addEventListener("click", (event) => {
            let track =
              `https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/${currentFolder}` +
              e
                .querySelector(".songname_author")
                .firstElementChild.innerHTML.trim() +
              ".mp3";
            if (currentSong.paused) {
                e.querySelector(".songCard").children[2].firstElementChild.src =
                  "https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/images/pause.svg";
                playMusic(track);
            } else {
                e.querySelector(".songCard").children[2].firstElementChild.src =
                  "https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/images/play.svg";
                currentSong.pause();
            }
        });
    });
...
async function displayAlbums() {
    let response = await fetch(
      `https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/songs/`
    );
    let txt = await response.text();
    // console.log(typeof(txt));
    let div = document.createElement("div");
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (element.href.includes("/songs/")) {
            ...
            let info = await fetch(
              `https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/songs/${foldername}/metadata.json`
            );
            ...
            cardContainer.innerHTML =
              ...
              `<div data-folder="${foldername}" class="card">
                            <img src="https://gist.githubusercontent.com/SinghIsWriting/MelodyBox-Your-Music-Library/tree/main/assets/songs/${foldername}/cover.jpg" alt="pic">
